...
(() =>
{
    ...
    var Q = (o, s, e) => s in o ? J(o, s, {enumerable : !0, configurable : !0, writable : !0, value : e}) : o[s] = e,
        q = (o, s) =>
        {
            ...
            if(G)
            {
                for(var e of G(s)) be.call(s, e) && Q(o, e, s[e]);
            }
            return o;
        };
    ...
    var ge = (o, s, e, t) =>
    {
        ...
        {
            for(let n of de(s)) !V.call(o, n) && n !== e && J(o, n, {
                get : () => s[n],
    ...
    var H = me((Re, F) =>
    {
        ...
        u.prototype.emit = function(s)
        {
            ...
            {
                for(var l = c.length, b = re(c, l), t = 0; t < l; ++t) Y(b[t], this, e);
            }
            return !0;
        };
        ...
        {
            var n, i, r;
            if(k(e), i = o._events, i === void 0 ? (i = o._events = Object.create(null), o._eventsCount = 0) : (i.newListener !== void 0 && (o.emit("newListener", s, e.listener ? e.listener : e), i = o._events), r = i[s]), r === void 0)
            {
                r = i[s] = e, ++o._eventsCount;
            }
            else if(typeof r == "function" ? r = i[s] = t ? [e, r] : [r, e] : t ? r.unshift(e) : r.push(e), n = ee(o), n > 0 && r.length > n && !r.warned)
            {
                r.warned = !0;
        ...
        {
            var t, n, i, r, a;
            if(k(e), n = this._events, n === void 0)
            {
                return this;
            }
            if(t = n[s], t === void 0)
    ...
    var I = class extends le.default
    {
        ...
        _subscribe(e, t)
        {
            if(this._centrifuge._debug("subscribing on", this.channel), this._centrifuge.state !== "connected" && !e)
            {
            ...
            if(this._usesToken())
            {
                if(this._token)
                {
                    return this._sendSubscribe(this._token, t);
                }
                {
                    if(e)
                    {
                        ...
                        function w()
                        {
                            return b.read().then(({done : h, value : _}) =>
                            {
                                ...
                                try
                                {
                                    if(s._protocol === "json")
                                    {
                                        for(a += s._utf8decoder.decode(_); c < a.length;) if(a[c] === `
`)
                                        {
        ...
        history(e, t)
        {
            ...
            return this._methodCall().then(function()
            {
                return i._callPromise(n, function(r)
                {
                    ...
                    if(a.publications)
                    {
                        for(let l = 0; l < a.publications.length; l++) c.push(i._getPublicationContext(e, a.publications[l]));
                    }
        ...
        _initializeTransport()
        {
            ...
            if(this._config.readableStream !== null ? r = this._config.readableStream : typeof window.ReadableStream != "undefined" && (r = window.ReadableStream), this._emulation)
            {
                ...
                for(; ;)
                {
                    ...
                    {
                        throw new Error("unknown transport " + f);
                    }
                    break;
                }
            }
            ...
            this._transport.initialize(this._config.protocol, {
                ...
                }, onClose : function(h)
                {
                    ...
                    if(h && "code" in h && h.code && (d = h.code), h && h.reason)
                    {
                        try
                        {
